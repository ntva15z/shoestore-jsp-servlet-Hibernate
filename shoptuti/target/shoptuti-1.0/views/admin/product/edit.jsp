			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<form class="form-horizontal" role="form" action="admin-Edit-Product" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="productId" id="form-field-1"  class="col-xs-10 col-sm-5"  value="${product.productId }">
										</div>
									</div>
									</c:if>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="name" id="form-field-1"  class="col-xs-10 col-sm-5"  value="${product.name }">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<c:if test="${product!=null }">
										<div class="col-sm-9">
											<img width="150px" height="150px" id="preview-img" src="<c:url value='/img/${product.image}'/>" alt="${product.image}"/>
										</div>
										</c:if>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="quantity" id="form-field-1"  class="col-xs-10 col-sm-5" value="${product.quantity }">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="price" id="form-field-1"  class="col-xs-10 col-sm-5" value="${product.price}">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" name="status" id="form-field-1" class="col-xs-10 col-sm-5" value="${product.status }">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Description </label>
										<div class="col-sm-9">
											<input type="text" name="description" id="form-field-1"  class="col-xs-10 col-sm-5" value="${product.description }">
										</div>
									</div>
